...
for xd in range(10000):
    ...
    ugen2.append(uaku)
    aa = 'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_9_6 rv:6.0; EO)'
    b = random.choice([
        '6',
        '7',
        '8',
    ...
    f = random.choice([
        ...
        'Y',
        'Z'])
    g = 'AppleWebKit/531.0.2 (KHTML, like Gecko) Chrome/'
